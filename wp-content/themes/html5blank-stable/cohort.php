...
<!--                COMMENCE FIRST ARTICLE-->
                  ...
                  <!-- <p>The Geekwise Academy Cohort program has been developed to bridge the gap between Geekwise Academy course students and their ability to move into roles as developers in the local technology industry.</p> -->
...
<!--              COMMENCE GOAL PRIOR TO NUMBER LIST-->
...
<!--              GOAL PRIOR TO NUMBER LIST ***END***-->

<!--              COMMENCE NUMBER LIST-->
               <!--<div>-->
               ...
               <!--         </li>-->
               <!--         <li>-->
               <!--             Confident in their problem solving abilites-->
               <!--         </li>-->
               <!--         <li>-->
               ...
               <!--         </li>-->
               <!--         <li>-->
               <!--             Driven to succeed, able to learn, and receive criticism-->
               <!--         </li>-->
               <!--     </ol>-->
